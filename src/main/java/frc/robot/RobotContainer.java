...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_driverController, 13).whileHeld(new RunIntake(m_intake, 0.8));
    ...
    new JoystickButton(m_driverController, 8).toggleWhenPressed(new ToggleIntake(m_intake));
    new JoystickButton(m_driverController, 9).whileHeld(new LiftRun(m_lift, 0.8));
    new JoystickButton(m_driverController, 9).whileHeld(new LiftRun(m_lift, -0.8));
    new JoystickButton(m_driverController, 10).whileHeld(new RunArm(m_arm, 1));
    new JoystickButton(m_driverController, 10).whileHeld(new RunArm(m_arm, -1));
    new JoystickButton(m_driverController, 11).whileHeld(new RunHopper(m_hopper, 0.5));
    new JoystickButton(m_driverController, 12).whileHeld(new RunHopper(m_hopper, -0.5));
