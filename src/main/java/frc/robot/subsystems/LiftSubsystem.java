...
public class LiftSubsystem extends SubsystemBase {
   ...
   */
  private final VictorSP rightLiftMotor = new VictorSP(LiftConstants.leftLiftMotorPort);
  private final VictorSP leftLiftMotor = new VictorSP(LiftConstants.rightLiftMotorPort);
  ...
  //encoder ters takılırsa true, düz takılırsa false yaz...

  public LiftSubsystem() {
    //2048 bir dönme olur. bir turda 1cm döner...
