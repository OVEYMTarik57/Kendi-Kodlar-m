...
public class Left3Cell extends SequentialCommandGroup {
   ...
   */
  public Left3Cell(SneakyTrajectory s_traTrajectory, Shooter shooter, intake intake, HopperSubsystem hopper, DriveSubsystem drive ) {
    ...
    super(
      ...
      s_traTrajectory.getRamsete(s_traTrajectory.Left3Cell[0]).andThen(() -> drive.arcadeDrive(0,0)));
